...
setup(
    name=package_name,
    version='0.0.1',
    packages=find_packages(where='src'),  # Cerca i pacchetti dentro 'src/'
    package_dir={'': 'src'},  # Indica che il codice si trova in 'src/'
    data_files=[
    ...
    'console_scripts': [
        ...
        'processes = px4_offboard.scripts.processes:main',  # Aggiunto processes.py
